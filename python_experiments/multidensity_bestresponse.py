...
parser.add_argument('--car-densities', type=int, default=5000, nargs='+', help="Car density across all lanes, cars per hour")
parser.add_argument('--car-dens-p', type = float, default=1.0, nargs='+', help="Proportion of vehicles in each density")
